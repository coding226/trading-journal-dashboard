...
var trades_pairs_option = {
    ...
    series: [{
        ...
        data: analytics_short_data['trades']
    }],
    xaxis: {
        categories: analytics_short_data['symbols'],
    },
    yaxis: {
        title: {
...
var trades_pairs_chart = new ApexCharts(
    document.querySelector("#short-trades-pairs-chart"),
    trades_pairs_option
);

trades_pairs_chart.render();

// short profitable pairs chart
var profit_pairs_option = {
    ...
    series: [{
        ...
        data: analytics_short_data['sum']
    }],
    xaxis: {
        categories: analytics_short_data['sumsymbols'],
    },
    yaxis: {
        title: {
            text: '% (Percentage Gain)'
...
var profit_pairs_chart = new ApexCharts(
    document.querySelector("#short-profit-pairs-chart"),
    profit_pairs_option
);
