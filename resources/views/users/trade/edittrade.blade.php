                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-5">
                                            <div class="input-group">
                                                <input class="datepicker-here form-control digits" name="end_date" type="text" value="{{ $trade->end_datetime == '' ? '' : date_format(date_create($trade->end_datetime),'m/d/Y') }}" data-language="en">
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="input-group clockpicker pull-center" data-placement="left" data-align="top" data-autoclose="true">
