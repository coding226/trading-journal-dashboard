...
@section('title')
<title>Privacy Policy | The Trading Buddy</title>
@endsection
@section('style')
@endsection
@section('content')
    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
            <div class="col-md-9 pt-5 text-center">
                <h3 class="mb-0 bread">Privacy Policy</h3>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row justify-content-center mb-5">
            <div class="col-md-8 heading-section text-left" data-aos="fade-up" data-aos-duration="1000">
                ...
                <p>Your privacy is important to us. It is Trading Buddy Limited's policy to respect your privacy and comply with any applicable law and regulation regarding any personal information we may collect about you, including across our website, <a href="https://thetradingbuddy.com">https://thetradingbuddy.com</a>, and other sites we own and operate.</p>
                ...
                <p>This policy is effective as of 9 May 2021.</p>
                ...
                <h4>Additional Disclosures for Australian Privacy Act Compliance (AU)</h4>
                ...
                <h4>Additional Disclosures for General Data Protection Regulation (GDPR) Compliance (EU)</h4>
                ...
                <h4>Additional Disclosures for California Compliance (US)</h4>
                ...
                <ul><li>Commercial information such as products or services history and purchases.</li></ul>
                ...
                <p>Trading Buddy<br/>admin@thetradingbuddy.com</p>
            </div>
        </div>
    </div>
</section>
