				...
				<div class="col-md-6 col-lg-2">
					<div class="ftco-footer-widget mb-4">
						...
						<ul class="list-unstyled">
							...
							<li><a href="#"><span class="ion ion-ios-arrow-round-forward me-2"></span>Contact us</a>
							</li>
						</ul>
					</div>
				</div>
				<div class="col-md-6 col-lg-2">
					<div class="ftco-footer-widget mb-4">
						...
						<ul class="list-unstyled">
							...
							<li><a href="#"><span class="ion ion-ios-arrow-round-forward me-2"></span>Terms &amp;
									Conditions</a></li>
				...
				<div class="col-md-6 col-lg">
					<div class="ftco-footer-widget mb-4">
						...
						<div class="block-21 mb-4 d-flex">
							<a class="img rounded" style="background-image: url(../assets/images/image_1.jpg);"></a>
							<div class="text">
								<div class="meta">
						...
						<div class="block-21 mb-4 d-flex">
							<a class="img rounded"
								style="background-image:url(../assets/images/ximage_2.jpg.pagespeed.ic.mQGyn1P_Li.jpg)"></a>
							<div class="text">
								<div class="meta">
									<div><a href="#"><span class="fa fa-calendar"></span> Dec. 12, 2020</a></div>
									<div><a href="#"><span class="fa fa-user"></span> Admin</a></div>
						...
						<div class="block-21 mb-4 d-flex">
							<a class="img rounded" style="background-image: url(../assets/images/image_4.jpg);"></a>
							<div class="text">
								<div class="meta">
									<div><a href="#"><span class="fa fa-calendar"></span> Dec. 12, 2020</a></div>
									<div><a href="#"><span class="fa fa-user"></span> Admin</a></div>
						...
						<div class="block-23 mb-3">
							<ul>
								...
								<li><a href="#"><span class="icon fa fa-paper-plane"></span><span class="text"><span
												class="__cf_email__"
												data-cfemail="cca5a2aaa38cb5a3b9bea8a3a1ada5a2e2afa3a1">[email&#160;protected]</span></span></a>
								</li>
							</ul>
						</div>
					</div>
...
<!-- Mirrored from preview.colorlib.com/theme/unbrew/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 May 2021 07:26:16 GMT -->
